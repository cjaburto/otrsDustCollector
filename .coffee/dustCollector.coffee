...
casper.then ->
  table = 7
  textRegex = /respuesta automática|no se puede entregar|Undeliverable|Undelivered|AntiPortonazo|UPS|Fuera de la oficina|Ausente|Delayed|Entrega retrasada|Análisis Modificaciones Ley|e-Contact Confirmación de informacion/gi
